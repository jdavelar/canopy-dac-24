...
43% of Canopy schools (N = 82) are not using tools to assess 'nontraditional' factors systematically across their schools. When schools did report using an assessment tool systematically, they did not report more than 1 on average.  
...
Most Canopy schools were not using the assessment tools we outlined to assess 'nontraditional' factors. Of those that selected from the list, 19% had adopted the Panorama survey and were using it systematically across their school or learning environment. However, most (35%) reported using some other tool systematically.  
...
tools %>% 
  ...
  labs(title = "Tools used to assess 'nontraditional' factors", x = "", y = "Number of schools") + 
...
variables %>% 
  ...
  coord_flip() +
  labs(x = "", y = "Number of schools", title = "Reported use for assessment tools to\nmeasure 'nontraditional' factors", fill = "Reported use") +
...
variables %>% 
  ...
  labs(x = "", y = "Number of schools", title = "Unfamiliar assessments") +
  geom_text(aes(label = n), nudge_y = 0.5, hjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans") +
  coord_flip()
```
...
variables %>% 
  ...
  theme(panel.grid.major.y = element_blank()) +
  labs(x = "", y = "Number of schools", title = "Tools schools have experimented with") +
  geom_text(aes(label = n), nudge_y = 0.5, hjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans") +
  coord_flip()
```
...
family %>% 
  ...
  labs(x = "", y = "Percent of schools", title = "Schools sharing 'non-traditional' assessment results with families") +
...
Across prekindergarten, elementary, middle, and high school grades, Canopy schools are using assessment tools to assess nontraditional factors at similar rates. Roughly half of prekindergarten, elementary, and high schools are using assessments, while 2 in 5 middle schools are using assessments.  
...
tools %>% 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1), labels = scales::percent_format()) +
  theme(panel.grid.major.x = element_blank()) +
  labs(x = "", y = "Percent of schools", title = "Nontraditional assessment tool use by level") +
  geom_text(aes(label = scales::label_percent(accuracy = 1)(pct)), nudge_y = 0.01, vjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans")
```
...
family %>% 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1), labels = scales::percent_format()) +
  theme(panel.grid.major.x = element_blank()) +
  labs(x = "", y = "Percent of schools", title = "Reporting of nontraditional assessment results to families by level") +
  geom_text(aes(label = scales::label_percent(accuracy = 1)(pct)), nudge_y = 0.01, vjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans")
```
...
variables %>% 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1), labels = scales::percent_format()) +
  theme(panel.grid.major.x = element_blank()) +
  labs(x = "", y = "Percent of schools", title = "Nontraditional assessment tool use by locale") +
  geom_text(aes(label = scales::label_percent(accuracy = 1)(pct)), nudge_y = 0.01, vjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans")
```

The majority of rural schools reporting the use of nontraditional assessments systematically shared the results of these assessments with families (81%).  A slightly smaller proportion of suburban and urban schools shared the results of these assessments with their families.  
...
variables %>% 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1), labels = scales::percent_format()) +
  theme(panel.grid.major.x = element_blank()) +
  labs(x = "", y = "Percent of schools", title = "Reporting of nontraditional assessment results to families by locale") +
  geom_text(aes(label = scales::label_percent(accuracy = 1)(pct)), nudge_y = 0.01, vjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans")
```
...
Most schools that reported using assessment tools to measure nontraditional factors were public district schools (42%) and public charter schools (35%). By contrast, only 1 in 5 independent (private) Canopy schools reported using assessment tools systematically.  
...
variables %>% 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1), labels = scales::percent_format()) +
  theme(panel.grid.major.x = element_blank()) +
  labs(x = "", y = "Percent of schools", title = "Nontraditional assessment tool use by school governance") +
  geom_text(aes(label = scales::label_percent(accuracy = 1)(pct)), nudge_y = 0.01, vjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans") +
  scale_x_discrete(labels = wrap_format(20))
```

Public district, charter, and independent schools reported the results of nontraditional assessments to families at similar rates. 3 in 4 district and independent schools using assessments systematically shared results with families, while 67% of charter schools shared results.  
...
variables %>% 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1), labels = scales::percent_format()) +
  theme(panel.grid.major.x = element_blank()) +
  labs(x = "", y = "Percent of schools", title = "Reporting of nontraditional assessment results to families by school governance") +
  geom_text(aes(label = scales::label_percent(accuracy = 1)(pct)), nudge_y = 0.01, vjust = 0, color = transcend_na, fontface = "bold", size = 5.5, family = "sans") +
  scale_x_discrete(labels = wrap_format(20))
```