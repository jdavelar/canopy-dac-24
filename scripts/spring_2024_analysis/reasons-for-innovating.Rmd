...
cat_by_year %>% 
  ...
  geom_hline(yintercept = 0, linetype = 2) +
  coord_flip() +
  labs(title = "How have Canopy schools' central motivation \nfor innovating changed since 2021?",
       y = "",
       x = "Catalyst",
       caption = "Data presented is for schools that responded in both 2021 \nand 2024 (N = 82). Red indicates a drop in selection and \nblue indicates an addition.") +
  theme(
    panel.grid.major.y = element_blank(),
    axis.text.y = element_text(size = rel(0.6))
  ) +
