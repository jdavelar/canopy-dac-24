...
increase_plot <- core_prac %>% 
  ...
  labs(
    ...
    title = "Core Practices with largest increase",
    subtitle = "These tags increased from 2022 to 2024 across schools."
  ) +
  theme(
    panel.grid.major.y = element_blank(),
    legend.position = "bottom",
...
decrease_plot <- core_prac %>% 
  ...
  labs(
    ...
    x = "Percentage of Canopy Schools",
    title = "Core Practices with largest decrease",
    subtitle = "These tags decreased from 2022 to 2024 across schools."
  ) +
  theme(
    panel.grid.major.y = element_blank(),
    legend.position = "bottom",
...
```{r}
library(patchwork)
increase_plot + decrease_plot + plot_layout(ncol = 1)
```
