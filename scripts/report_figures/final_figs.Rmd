...
fig_17 <- ggplot(plot_dat, aes(y = reorder(term, -estimate), x = deviation, fill = sig)) +
  ...
  labs(
    ...
    y = "",
    title = str_wrap("Figure 6. Estimated Effect on Number of Practices Modified by Schools Between Survey Responses", 42),
...
fig_19 <- ggplot(waffle_summary, aes(factor(potential_years), waffle_per_sch)) +
  ...
  labs(x = "", 
       ...
       title = "Figure 7. Average switchbacks per school from 2021-2023") +
  theme(panel.grid.major.x = element_blank(),
