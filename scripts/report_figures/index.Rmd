...
.method-note {
  border: 2px solid #174A72; /* Replace #3498db with your hex color */
  padding: 10px;
  margin: 15px 0;
  border-radius: 5px;
  background-color: #174A72; /* Background color */
  color: #FFFFFF; /* Text color */
  font-family: "Lucida Sans", "Lucida Grande", "Lucida Sans Unicode", sans-serif; /* Text font */
...
a {
  color: #0178BA; /* Replace with your desired hex color */
  text-decoration: none; /* Optional: Removes the underline */
}

/* Change color when hovered */
a:hover {
  color: #E38C34; /* Replace with hover color */
